...
<head>
    ...
    <!-- Page Title -->
    <title>CodeandPix | Get in Touch</title>
        ...
        <div class="stg-container">
            ...
            <section class="backlight-bottom">
                ...
                <div class="bringer-parallax-media" data-parallax-speed="20" data-appear="fade-up" data-delay="200" data-unload="fade-up">
                    <img class="bringer-lazy" src="img/null.png" data-src="img/contact.jpg" alt="Get in Touch" width="1920" style="height:500px">
            ...
            <section>
                ...
                <div class="stg-row stg-bottom-gap-l">
                    <div class="stg-col-6 stg-offset-6" data-appear="fade-up" data-delay="200" data-unload="fade-up">
                        <p>We believe in the power of collaboration and shared passion. We're not just a creative agency, we're your partners in igniting your brand's unique potential. So, whether you're brimming with ideas or just starting to spark, reach out and let's chat!</p>
                    </div>
                </div>
                <!-- Grid Galery -->
                ...
                <div class="stg-row bringer-section-title">
                    <div class="stg-col-8 stg-offset-2">
                        <div class="align-center">
                            ...
                            <p class="bringer-large-text" data-appear="fade-up" data-delay="100" data-unload="fade-up">Here's how you can connect with the team:</p>
                        </div>
                    </div>
                </div>
                <!-- Contacts Grid -->
            ...
            <section>
                ...
                <div class="stg-row">
                    <div class="stg-col-4 stg-tp-col-6 stg-m-bottom-gap" data-appear="fade-right" data-delay="100" data-unload="fade-left">
                        ...
                        <div class="bringer-block stg-aspect-square stg-vertical-space-between">
                            ...
                            <div>
                                ...
                                <h6>Flat no 5, Priya Appartments,<br>Madhura Nagar, Ammerpet, <br>Hyderabad, Telangana,<br>500038</h6>
                            </div>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.4474187982914!2d78.43649077550373!3d17.4382866834576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb90da932c39c5%3A0xfbf2cb79c1fa6b5d!2sPriya%20Apartments%2C%20A%20-%2038%2C%20Lata%20Enclave%2C%20Madhura%20Nagar%2C%20Hyderabad%2C%20Telangana%20500045!5e0!3m2!1sen!2sin!4v1728045141642!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </section>
            ...
            <section class="backlight-top is-fullwidth">
                <div class="stg-row stg-valign-middle stg-cta-with-image stg-tp-column-reverse">
                    <div class="stg-col-5" data-unload="fade-left">
                        <div class="bringer-offset-image" data-bg-src="img/contact-1.jpg" data-appear="fade-up" data-threshold="0.25"></div>
